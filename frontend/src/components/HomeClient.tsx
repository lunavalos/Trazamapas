...
import { PayloadTrip, PayloadTripCategory } from "@/lib/payload";
export default function HomeClient({ trips, categories }: { trips: PayloadTrip[], categories: PayloadTripCategory[] }) {
  return (
